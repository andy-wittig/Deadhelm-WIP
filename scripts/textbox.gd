...
@onready var npc_voice = $npcVoice
@onready var text_label = $TextLabel
@onready var exit_button = $ExitButton
@onready var next_button = $NextButton
@onready var menu_layer = $"../.."
@onready var headshot_sprite = $HeadshotSprite
...
func start_textbox(npc_text_path : String, headshot : Texture2D):
	...
	if (text_file != null):
		...
		headshot_sprite.texture = headshot
